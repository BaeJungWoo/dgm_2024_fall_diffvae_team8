...
python main/train_ddpm.py +dataset=cifar10/train \
                     ...
                     dataset.ddpm.training.vae_chkpt_path=\'/home/jungwoo/HW/DiffuseVAE/results/vae/checkpoints/vae-cifar10_alpha=1.0-epoch=499-train_loss=0.0000.ckpt\' \
                     dataset.ddpm.training.device=\'gpu:0,1,2,3\' \
                     dataset.ddpm.training.results_dir=\'/home/jungwoo/HW/DiffuseVAE/results/ddpm/\' \
